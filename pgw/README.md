...
Modbus TCP/RTU + Меркурий + IEC 60870-5-104 + OPC UA → единое пространство тегов → Modbus TCP Server.
Реализация v0.1 по `TZ_protocol_gateway_v0_1.md`.
...
OPC UA Client      ──┘   +timestamp)        └── (REST /runtime, /config)
```
